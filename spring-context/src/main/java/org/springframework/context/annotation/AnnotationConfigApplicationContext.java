...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		...
		/**
		 * 1、完成spring内置的BeanDefinition的注册。将内置的BeanDefinition放入org.springframework.beans.factory.support.DefaultListableBeanFactory#beanDefinitionMap集合中
		 ...
		 * 	2、创建	AnnotatedBeanDefinitionReader对象
		 */
		this.reader = new AnnotatedBeanDefinitionReader(this);
		createAnnotatedBeanDefReader.end();
		//创建ClassPathBeanDefinitionScanner对象：
		// 初始化org.springframework.context.annotation.ClassPathBeanDefinitionScanner.registry=AnnotationConfigApplicationContext
		// 初始化环境 Environment
		// 初始化ResourceLoader
	...
	public void register(Class<?>... componentClasses) {
		...
		//利用初始化AnnotationConfigApplicationContext时创建的AnnotatedBeanDefinitionReader对象，将主配置类注册到BeanDefinitionMap集合中
